<section class="logo-search">
  <div class="container">
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 logo">
      <a href="<?php echo base_url() ?>"><img src="<?php echo base_url() ?>public/images/logo_fresh.png" alt="Logo Shop"></a>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 search">
      <div class="contact-row">
        <div class="phone inline">
          <i class="icon fa fa-phone"></i> 0985 456 214
        </div>
        <div class="contact inline">
          <i class="icon fa fa-envelope"></i> freshmarket@gmail.com
        </div>
      </div>
