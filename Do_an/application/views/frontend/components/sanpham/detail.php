					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="product-view-content">
							...
							<div class="fk-boxs" id="km-all" data-comt="False">
								<div id="km-detail">
									<p class="fk-tit">Khuyến mại đặc biệt (Nhân dịp Giáng sinh)</p>
									<div class="fk-main">
										<div class="fk-sales">
											</ul>
											<ul>
												<li>Tặng phiếu mua hàng 500,000đ (khi phiếu mua hàng trên 1,000,000 đ)</li>
											</ul>
											<ul>
												<li>Tặng túi xách Gucci chính hãng (Áp dụng đến 26/05) <a href="#" target="_blank">Xem chi tiết</a>
												</li>
											</ul>
											<ul>
												<li>Giảm thêm 50,000đ khi mua combo Hộp quà đặc biệt (HỘP QUÀ TERRISA SIGNATURE PHIÊN BẢN ĐẶC BIỆT + GIỎ QUÀ TERRISA SIGNATURE X-MAS 1 + HỘP QUÀ TERRISA SIGNATURE X-MAS 2) <a href="#" target="_blank">Xem chi tiết</a>
												</li>
											</ul>
										</div>
									</div>
							...
							<div style="margin-top: 20px;">
								<b>Tình trạng</b>
								<br>
								<span>Nguyên hộp. Đầy đủ giấy tờ bảo quản, hạn sử dụng.</span>
							</div>
							<div style="margin-top: 20px;">
								<b>Chất lượng</b>
								<br>
								<span>Thực phẩm sạch đã được kiểm chứng</span><a href="#" style="color:red"> (Chi tiết)</a>
							</div>
						</div>
					</div>
